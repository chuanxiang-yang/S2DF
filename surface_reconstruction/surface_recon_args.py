...
def get_train_args():
    ...
    parser.add_argument('--K', type=float, default=1000)
...
def get_test_args():
    ...
    parser.add_argument('--epoch_n', type=int, nargs='+', default=np.arange(0, 10000, 500).tolist(), help='epoch number to evaluate')
    parser.add_argument('--index', type=int, default=-1, help='which to draw')
    parser.add_argument('--conf', type=str, default='', help='path of conf')
